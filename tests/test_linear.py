...
@typed
def benchmark_hyperparameters(n_runs: int = 20, test_size: float = 0.8):
    ...
    datasets = [
        ...
        ("Medium-LowNoise", lambda: generate_regression(n_samples=1000, n_features=20, noise=0.1)),
        ("Medium-HighNoise", lambda: generate_regression(n_samples=1000, n_features=20, noise=0.5)),
        ("Large-LowNoise", lambda: generate_regression(n_samples=3000, n_features=50, noise=0.1)),
        ("Large-HighNoise", lambda: generate_regression(n_samples=3000, n_features=50, noise=0.5)),
        ("Outliers-10pct", lambda: generate_regression(n_samples=1000, n_features=20, noise=0.1, outliers=0.1)),
        ("Outliers-30pct", lambda: generate_regression(n_samples=1000, n_features=20, noise=0.1, outliers=0.3)),
        # ("MoreNoninformative", lambda: generate_regression(n_samples=500, n_features=20, noise=0.1, noninformative=0.8)),
    ]

    # Define hyperparameter values to test
    alphas = [1e-6, "bayes"]  # , "ard"]
